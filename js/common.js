...
// GRID
	...
	$('.og-grid').on('click', '.og-details a', function(event) {
		event.preventDefault();
		tempScrollTop = $(window).scrollTop();
		$('.general').hide();
		$('.preview_screen').fadeIn();
		$('.screen').removeClass('holder').addClass('holder');
    ...
    $('.screen').removeClass('holder');
		...
		myPosition = $(this).closest('.cd-section').attr('id');
	});

	$('.preview_screen').on('click', '.og-close', function(event) {
		event.preventDefault();
		$('.preview_screen').hide();
		$('.general').fadeIn();
